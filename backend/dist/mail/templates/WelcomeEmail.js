...
const WelcomeEmail = ({ firstName }) => {
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "Welcome to B2C E-commerce!"),
                ...
                React.createElement(components_1.Container, { className: "border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]" },
                    React.createElement(components_1.Section, { className: "mt-[32px]" },
                        React.createElement(components_1.Heading, { className: "text-black text-[24px] font-normal text-center p-0 my-[30px] mx-0" },
                            "Welcome to ",
                            React.createElement("strong", null, "B2C E-commerce"))),
                    React.createElement(components_1.Text, { className: "text-black text-[14px] leading-[24px]" },
                        "Hello ",
                        firstName,
                        ","),
                    React.createElement(components_1.Text, { className: "text-black text-[14px] leading-[24px]" }, "We're excited to have you on board! You can now explore our vast collection of products and enjoy a seamless shopping experience."),
                    React.createElement(components_1.Section, { className: "text-center mt-[32px] mb-[32px]" },
                        React.createElement(components_1.Link, { className: "bg-[#000000] rounded text-white text-[12px] font-semibold no-underline text-center px-5 py-3", href: "http://localhost:3000" }, "Start Shopping")),
                    React.createElement(components_1.Text, { className: "text-black text-[14px] leading-[24px]" },
                        "or copy and paste this URL into your browser:",
                        " ",
                        React.createElement(components_1.Link, { href: "http://localhost:3000", className: "text-blue-600 no-underline" }, "http://localhost:3000")))))));
};

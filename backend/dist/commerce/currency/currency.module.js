...
exports.CommerceCurrencyModule = void 0;
const common_1 = require("@nestjs/common");
const currency_service_1 = require("./currency.service");
const prisma_module_1 = require("../../prisma/prisma.module");
const redis_module_1 = require("../../redis/redis.module");
let CommerceCurrencyModule = class CommerceCurrencyModule {
};
exports.CommerceCurrencyModule = CommerceCurrencyModule;
exports.CommerceCurrencyModule = CommerceCurrencyModule = __decorate([
    (0, common_1.Module)({

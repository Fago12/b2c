...
exports.CommerceShippingModule = void 0;
const common_1 = require("@nestjs/common");
const shipping_service_1 = require("./shipping.service");
const prisma_module_1 = require("../../prisma/prisma.module");
const settings_module_1 = require("../../settings/settings.module");
let CommerceShippingModule = class CommerceShippingModule {
};
exports.CommerceShippingModule = CommerceShippingModule;
exports.CommerceShippingModule = CommerceShippingModule = __decorate([
    (0, common_1.Module)({
